...
let ListAdminAdsUseCase = class ListAdminAdsUseCase {
    repo;
    mapper;
...
ListAdminAdsUseCase = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [AdsRepository, AdMapper])
], ListAdminAdsUseCase);
export { ListAdminAdsUseCase };
//# sourceMappingURL=list-admin-ads.usecase.js.map